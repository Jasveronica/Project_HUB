      ...
      <section className="dark:bg-darkmode pt-8 md:pb-24 pb-16">
        <div className="container mx-auto max-w-6xl px-4">
              ...
              <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                <div>
                  ...
                  <p className="text-DeepOcean font-normal text-lg max-w-80 pt-3 pb-7 dark:text-white/50">
                    Please feel free to reach out anytime. We respond quickly
            ...
            <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
              ...
              <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                <div>
                  ...
                  <p className="text-DeepOcean font-normal text-lg max-w-80 pt-3 pb-7 dark:text-white/50">
                    We welcome passionate developers and creators. Submit your
                    profile to collaborate with Project Hub.
                  </p>
                </div>
                <div>
                  <Link
          ...
          <div className="md:pt-32 pt-11 md:pb-28 pb-8">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d125766.19577315885!2d78.04042151442975!3d9.917826796705537!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b00c582b1189633%3A0xdc955b7264f63933!2sMadurai%2C%20Tamil%20Nadu!5e0!3m2!1sen!2sin!4v1765017241949!5m2!1sen!2sin"
              width="1114"
              height="477"
              loading="lazy"
