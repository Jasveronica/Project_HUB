        ...
        >
          <div className="flex gap-1 items-center">
            ...
            <span className="font-bold text-midnight_text text-sm dark:text-white/50">
              Empowering Vision, Delivering Excellence
            </span>
          </div>
          <h3 className="text-midnight_text font-bold dark:text-white text-4xl  md:text-5xl md:leading-[1.15]">
            Innovation Meets Execution - Welcome to Project Hub
          </h3>
          ...
          <a
            href="#about"
            className="py-3 bg-blue-600 text-white font-bold rounded-md hover:bg-blue-700 transition duration-300 px-8"
          >
            Build With Us
          </a>
