      ...
      <div className="container mx-auto max-w-6xl px-4">
        <div className="grid md:grid-cols-12 grid-cols-1 md:gap-7 gap-0">
          ...
          >
            ...
            <h2 className="sm:text-4xl text-[28px] leading-tight font-bold text-white py-12 font-playwrite">
            ...
            <div className="grid grid-cols-6 pb-12 border-b border-dark_border ">
              ...
              <div className="col-span-6 pt-8">
                ...
                <p className="bg-transparent border-0 text-white text-lg">
                  Southern Part Of Tamilnadu , Madurai.
                </p>
              </div>
            </div>
            <div className="pt-12">
              ...
              <div className="flex items-center flex-wrap md:gap-14 gap-7">
                ...
                />
                <Image
                  src={getImgPath("/images/contact/phone.png")}
                  alt="phonepe"
                  width={100}
                  height={20}
                  style={{
                ...
                />
                <Image
                  src={getImgPath("/images/contact/payt.png")}
                  alt="Paytm"
                  width={100}
                  height={20}
                  style={{ width: "auto", height: "auto" }}
                ...
                />
                <Image
                  src={getImgPath("/images/contact/supe.png")}
                  alt="SuperMoney"
                  width={100}
                  height={20}
                  style={{ width: "auto", height: "auto" }}
            ...
            <div className="lg:mt-0 mt-8  bg-white dark:bg-darkmode max-w-[50rem] m-auto pt-[2.1875rem] pb-8 px-[2.375rem] rounded-md relative z-10">
              ...
              <form className="flex w-full m-auto justify-between flex-wrap gap-4">
                ...
                <div className="w-full">
                  ...
                  >
                    <a
                      href="mailto:projecthubsolutionz@gmail.com?subject=Project Inquiry&body=Hi, I want to discuss my project."
                      className="w-full bg-primary hover:bg-blue-700 text-white py-1 rounded-lg text-center block"
                    >
                      Submit Inquiry
                    </a>
                  </button>
