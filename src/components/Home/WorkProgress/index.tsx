        ...
        <div className="grid md:grid-cols-12 items-center gap-7">
          ...
          >
            <div className="flex gap-2 items-center">
              <span>🔹</span>
              <span className="font-bold text-midnight_text text-sm dark:text-white/50">
                Build Everything
              </span>
            </div>
            ...
            <p className="text-gray dark:text-white/70 text-base font-medium leading-7">
              Project Hub focuses on crafting modern, scalable, and
              user-friendly digital experiences. From academic final-year
              projects to professional client applications, we ensure clean
              architecture, smooth UI, and fast deployment. We combine
              creativity with practical engineering to deliver solutions that
              are simple, efficient, and future-ready.
            </p>
